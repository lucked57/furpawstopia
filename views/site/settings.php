                ...
                <div class="list-group-item">
                    <div class="row align-items-center">
                        <div class="col">
                            ...
                            <p class="text-muted mb-0">Unusual activity notifications for your account</p>
                        </div>
                        <div class="col-auto">
                            <div class="custom-control custom-switch">
                                

                                <input data-bs-toggle="modal" data-bs-target="#not_available" checked="" class="form-check-input" type="checkbox" value="" id="flexCheckDefault"><label class="form-check-label" for="flexCheckDefault"></label>
                ...
                <div class="list-group-item">
                    <div class="row align-items-center">
                        <div class="col">
                            ...
                            <p class="text-muted mb-0">Unauthorized financial activity policy</p>
                        </div>
                        <div class="col-auto">
                            <div class="custom-control custom-switch">
                                <input data-bs-toggle="modal" data-bs-target="#not_available" class="form-check-input" type="checkbox" value="" id="flexCheckDefault"><label class="form-check-label" for="flexCheckDefault"></label>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="list-group-item">
                    <div class="row align-items-center">
                        <div class="col">
                            ...
                            <p class="text-muted mb-0">We can send updates about news to your email</p>
                        </div>
                        <div class="col-auto">
                            <div class="custom-control custom-switch">
                                <input data-bs-toggle="modal" data-bs-target="#not_available" checked="" class="form-check-input" type="checkbox" value="" id="flexCheckDefault"><label class="form-check-label" for="flexCheckDefault"></label>
